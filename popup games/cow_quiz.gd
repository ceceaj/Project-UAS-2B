...
@onready var quiz_panel = $UI/MaterialPanel/MaterialContentBox/QuizPanel
...
func answer_question(selected_index: int):
	if not can_answer:
		return
	...
	var question_data = questions[current_question_index]
	var correct_index = question_data["correct"]
...
func show_quiz_finished():
	print("Kuis selesai. Skor: ", score, " dari ", questions.size())
...
func show_result_text():
	...
	if score == questions.size():
		title_result = "Hebat!"
		message = "Kamu menyelesaikan level dengan sempurna!"
